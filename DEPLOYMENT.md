...
ALLOWED_HOSTS=yourdomain.com,www.yourdomain.com,172.235.33.181,104.64.0.164,localhost
...
- [ ] `ALLOWED_HOSTS` contains your domain (and `172.235.33.181`, `104.64.0.164`, and `localhost` for VPS testing)
